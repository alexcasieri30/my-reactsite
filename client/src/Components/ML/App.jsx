...
function MachineLearningHome(){
    ...
    return <div className="ml-home-container">
        <div className="ml-top-controls">
            ...
            <div className="ml-top-right">
                <div className="ml-top-dropdown">
                    <Dropdown currentPage={"Machine Learning"}></Dropdown>
                </div>
            </div>
        </div>
        ...
        <div className="project">
            ...
            <div className="numbers-body" id="numbers-project">
                <div className="numbers">
                    ...
                    <div className="numbers-result-pred">
                        <div className="numbers-result-pred-title">
                            Prediction: 
                        </div>
                        <div className="numbers-result-pred-num">
                            {
                ...
                <div className="numbers-result-perc">
                    <div className="numbers-result-perc-graph">
                    {
                        numbersResult && JSON.parse(numbersResult[1]).map((res) => {
                            let perc = (parseFloat(res) / 1.0 * 300).toString();
                            console.log("PERC: ", perc);
                            let margin_top = 300 - perc;
                            return <div className="number-perc" style={{height: perc + "px", marginTop: margin_top + "px", backgroundColor:"rgba(0,0,0,0.4)"}}>{Math.round(res * 1000000)/10000}%</div>
                        })
                    }
                    {
                        !numbersResult && emptyNums.map((item) => {
                            return <div className="number-perc" style={{height: "0px", marginTop: "300px"}}></div>
                        })
                    }
                    </div>
                    <div className="numbers-result-perc-xaxis">
                    {
                        numbersResult && JSON.parse(numbersResult[1]).map((res, i) => {
                            console.log(i);
                            return <div className="x-axis"><strong>{i}</strong></div>
                        })
                    }
                    </div>
                    <div className="numbers-result-perc-expl">
                        Neural Network's predicted probabilities of each number
                    </div>
                </div>
            </div>
            </div>
